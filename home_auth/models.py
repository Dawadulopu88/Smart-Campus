...
class CustomUser(AbstractUser):
    ...
    groups = models.ManyToManyField("auth.Group", related_name=None, blank=True)
    user_permissions = models.ManyToManyField("auth.Permission", related_name=None, blank=True)
...
class PasswordResetRequest(models.Model):
    ...
    def send_reset_email(self):
        ...
        message = f"Click the following link to reset your password: http://localhost:8000/reset-password/{self.token}"
